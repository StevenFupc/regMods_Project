...
performance, including: , Fuel economy (in miles per gallon), Number
of cylinders, Engine displacement (in cubic inches), Horsepower, Rear
axle ratio, Weight (in thousands of pounds), Quarter mile time (in
seconds), Cylinder arrangement (either V or straight), Transmission
(either automatic or manual), Number of forward gears and Number of
carburetors
